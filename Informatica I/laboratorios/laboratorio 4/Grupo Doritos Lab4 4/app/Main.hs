...
transformacionLineal ((m11, m12), (m21, m22)) (x, y) = ((m11 * x)+ (m21 * y), (m12 * x) + (m22 * y))

aplicarTransformaciones :: ListaTransformaciones -> (Float, Float) -> (Float, Float)
aplicarTransformaciones (Matriz (m11, m12) (m21, m22) lt) (x, y) = aplicarTransformaciones lt (transformacionLineal ((m11, m12), (m21, m22)) (x, y) )
...
contar2 :: Lista -> Int
contar2 Nil = 0
contar2 (Cons a as) = a + contar2 as

contar3 :: Lista -> Int
contar3 Nil = 0
contar3 (Cons b bs) = b + contar3 bs
