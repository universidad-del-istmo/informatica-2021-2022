...
-- presicion de los valores de tipo Float tal quees
...
esEquilatero (x1, y1) (x2, y2) (x3, y3) = 
  --(sqrt ((x2-x1)^2 + (y2-y1)^2) + sqrt ((x1-x3)^2 + (y1-y3)^2)) - (sqrt ((x3-x2)^2 + (y3-y2)^2) + sqrt ((x1-x3)^2 + (y1-y3)^2)) <=0.000001
  abs (sqrt ((x2-x1)^2 + (y2-y1)^2) - sqrt ((x3-x2)^2 + (y3-y2)^2)) <=0.01 && abs (sqrt ((x3-x2)^2 + (y3-y2)^2) - sqrt ((x1-x3)^2 + (y1-y3)^2)) <=0.01
  &&  abs (sqrt ((x2-x1)^2 + (y2-y1)^2) - sqrt ((x1-x3)^2 + (y1-y3)^2)) <=0.01
--Distancia de A-B, B-C, C-A 
--Lado A = sqrt ((x2-x1)^2 + (y2-y1)^2)
--Lado B = sqrt ((x3-x2)^2 + (y3-y2)^2)
--Lado C = sqrt ((x1-x3)^2 + (y1-y3)^2)
...
valorangulo n = n * 2 * pi /360

rotacion :: Float -> (Float, Float) -> (Float, Float)
rotacion angulo = transformacionLineal ((coseno, negativoseno), (seno, cosenodos))
    where 
      anguloResultado       = valorangulo angulo
      coseno       = cos anguloResultado
      negativoseno = -1 * sin anguloResultado
      seno         = sin anguloResultado
      cosenodos    = cos anguloResultado
