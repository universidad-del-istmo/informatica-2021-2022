...
/* package Andrea-Isabel-0.1.0.0 */
#ifndef VERSION_Andrea_Isabel
#define VERSION_Andrea_Isabel "0.1.0.0"
#endif /* VERSION_Andrea_Isabel */
#ifndef MIN_VERSION_Andrea_Isabel
#define MIN_VERSION_Andrea_Isabel(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Andrea_Isabel */
...
#define CURRENT_COMPONENT_ID "Andrea-Isabel-0.1.0.0-inplace-Andrea-Isabel"
