...
import Prelude(Bool, Float, undefined, (==), (+), sqrt, (-), (^), (&&), (*), (>=), (<=), pi, cos, sin, abs, (/) )
...
rotacion anguloTotal punto = transformacionLineal ((m11, m12), (m21, m22)) punto 

-- m = matriz 
-- a = angulo 

-- operacionAngulo -> a = a * 2 * pi / 360 
